...
import { devicesRouter, thresholdsRouter, alarmsRouter, readingsRouter, auditRouter, escalationRouter, calibrationRouter, inspectionRouter } from './api';
...
async function startServer() {
  try {
    ...
    const server = app.listen(config.port, () => {
      ...
      logger.info('  POST /api/inspection/templates');
      logger.info('  GET  /api/inspection/templates');
      logger.info('  GET  /api/inspection/templates/:id');
      logger.info('  POST /api/inspection/templates/:id/publish');
      logger.info('  POST /api/inspection/templates/:id/close');
      logger.info('  POST /api/inspection/templates/:id/revoke');
      logger.info('  POST /api/inspection/records/submit');
      logger.info('  GET  /api/inspection/records');
      logger.info('  GET  /api/inspection/records/:id');
      logger.info('  GET  /api/inspection/stats/counts');
      logger.info('  GET  /api/inspection/export');
      logger.info('');
